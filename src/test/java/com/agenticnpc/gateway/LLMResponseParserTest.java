...
class LLMResponseParserTest {
    ...
    void standardJsonParsed() {
        ...
        Optional<LLMResponse> result = parser.parse(json);
    ...
    void markdownWrappedParsed() {
        ...
        Optional<LLMResponse> result = parser.parse(wrapped);
        assertTrue(result.isPresent());
    ...
    void plaintextFallback() {
        ...
        Optional<LLMResponse> result = parser.parse(plaintext);
        assertTrue(result.isPresent());
        assertEquals("NONE", result.get().action_type());
    ...
    void plaintextTruncated() {
        ...
        Optional<LLMResponse> result = parser.parse(longText);
        assertTrue(result.isPresent());
    ...
    void nullInputReturnsEmpty() {
        Optional<LLMResponse> result = parser.parse(null);
    ...
    void blankInputReturnsEmpty() {
        Optional<LLMResponse> result = parser.parse("   \n  \t  ");
        assertTrue(result.isEmpty());
    }
    ...
    void malformedJsonReturnsEmpty() {
        ...
        Optional<LLMResponse> result = parser.parse(bad);
        assertTrue(result.isEmpty());
    }
